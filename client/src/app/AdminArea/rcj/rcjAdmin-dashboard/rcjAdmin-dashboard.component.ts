...
@Component({
  selector: 'Rcj-admin-dashboard',
  templateUrl: './rcjAdmin-dashboard.component.html',
  styleUrls: ['./rcjAdmin-dashboard.component.scss']
})
export class RCJAdminDashboardComponent implements OnInit {
  translate = this.commonService.returnTranslate();
  textToshow:string=this.translate.instant('COMMON.More');
 ...
 data:any;
  ...
  navigateTo(statusId){
    ...
    this.router.navigate(['/AdminArea/rcj-requests',9,statusId]);
  }
}
